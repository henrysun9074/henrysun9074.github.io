...
I am interested in the dynamics of genome and chromosome evolution in marine invertebrates. Macrosynteny refers to large-scale chromosome structure conservation over deep evolutionary time, and can provide insight into major genomic rearrangements across different lineages.  Currently, we are studying genome evolution in limpets, using these ancient gastropods to investigate patterns of macrosynteny and chromosome evolution. Limpets display marked reductions in chromosome number and genome size compared to other gastropods and mollusks, many of which show remarkable preservation of the hypothesized ancestral bilaterian karyotype. Thus, limpets provide a useful system for examining how chromosomes and genomes evolve across evolutionary history and influence adaptation.
